    ...
    <h2 className={`text-3xl font-bold tracking-tight ${
      ...
      <span className={`block ${
            dark === "true"
              ? " text-gray-100"
              : " text-gray-800"
          }`}>Be the first to know about crypto news every day</span>
      <span className="block text-blue-600">Ready to dive in?</span>
    </h2>
    <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
      <div className="inline-flex rounded-md shadow">
        <a href="#" className="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-5 py-3 text-base font-medium text-white hover:bg-indigo-700">Get started</a>
      </div>
